namespace UniversidadXYZ.Presentacion.CRUD
{
    partial class FrmEstudiante
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblCuenta=new System.Windows.Forms.Label(); this.txtCuenta=new System.Windows.Forms.TextBox();
            this.lblPin=new System.Windows.Forms.Label(); this.txtPin=new System.Windows.Forms.TextBox();
            ...
            Helper.Etiqueta(lblCuenta,"Cuenta:",10,322,80); Helper.Caja(txtCuenta,90,322,200);
            Helper.Etiqueta(lblPin,"PIN:",10,354,80); 
            Helper.Caja(txtPin,90,354,150); 
            this.txtPin.PasswordChar='*';
            var lbl=new System.Windows.Forms.Label();lbl.Text="(dejar vacío para no cambiar)";lbl.Location=new System.Drawing.Point(250,358);lbl.AutoSize=true;lbl.ForeColor=System.Drawing.Color.Gray;
            ...
            this.ClientSize=new System.Drawing.Size(750,440); this.Text="Gestión de Estudiantes";
            this.Controls.AddRange(new System.Windows.Forms.Control[]{dgv,lblPersona,cmbPersona,lblCuenta,txtCuenta,lblPin,txtPin,lbl,btnNuevo,btnGuardar,btnEliminar,btnCancelar});
            ((System.ComponentModel.ISupportInitialize)(this.dgv)).EndInit(); this.ResumeLayout(false);
        }
        private System.Windows.Forms.DataGridView dgv;
        private System.Windows.Forms.Label lblPersona,lblCuenta,lblPin;
        private System.Windows.Forms.ComboBox cmbPersona;
        private System.Windows.Forms.TextBox txtCuenta,txtPin;
